...
export const InvoiceSection = React.memo(function InvoiceSection({
  ...
  }, [orderSlugForInvoice, exportInvoice, tToast])
  ...
  return (
    <View style={invoiceStyles.invoiceSection}>
        ...
        >
          <View style={invoiceStyles.downloadRow}>
            ...
            <View style={invoiceStyles.flex1}>
              <Text
                style={[
                  invoiceStyles.smSemibold,
                  { color: isDark ? colors.gray[100] : colors.gray[900] },
                ]}
              >
                {isExportingInvoice
                  ? tCommon('common.downloadingInvoice')
                  : tCommon('common.savingFile')}
              </Text>
              <Text
                style={[
                  invoiceStyles.xsText,
                  {
              ...
              >
                {isExportingInvoice
                  ? tCommon('common.pleaseWait')
                  : tCommon('common.savingToDownloads')}
              </Text>
            </View>
            {progress > 0 && (
              <View
                style={[
                  invoiceStyles.progressBadge,
                  { backgroundColor: `${primaryColor}18` },
                ]}
              >
                <Text style={[invoiceStyles.smBold, { color: primaryColor }]}>
                  {progress}%
                </Text>
              </View>
            )}
      ...
      {fileName && !isDownloading && !isExportingInvoice && (
        <View
          style={[
            invoiceStyles.successCard,
            {
              backgroundColor: isDark
                ? 'rgba(20, 83, 45, 0.2)'
                : colors.success.bgLight,
              borderColor: isDark
                ? colors.success.borderDark
                : colors.success.borderLight,
            },
          ]}
        >
          <View style={invoiceStyles.downloadRow}>
            ...
            <View style={invoiceStyles.flex1}>
              ...
              >
                {tCommon('common.downloadSuccess')}
              </Text>
              <Text
                style={[
                  invoiceStyles.xsText,
              ...
              >
                {Platform.OS === 'android'
                  ? tCommon('common.fileSavedToDownloads')
                  : tCommon('common.fileSavedToFilesApp')}
              </Text>
            </View>
          </View>
        </View>
