...
import { capitalizeFirstLetter, formatCurrency, formatDateTime } from '@/utils'
        ...
        <View style={cardStyles.body}>
          ...
          >
              ...
              <>
                ...
                {(cartTotals.promotionDiscount ?? 0) > 0 && (
                  <View style={cardStyles.summaryRow}>
                    <Text
                      style={[
                        cardStyles.summaryLabelMuted,
                        { color: isDark ? colors.gray[600] : colors.gray[600] },
                      ]}
                    >
                      {labels.promotionDiscount}
                    </Text>
                    <Text
                      style={[
                        cardStyles.summaryValueMuted,
            ...
            >
              <Text
                style={[
                  cardStyles.totalLabel,
                  { color: isDark ? colors.gray[50] : colors.gray[900] },
                ]}
              >
                {labels.totalPayment}
              </Text>
              <Text style={[cardStyles.totalValue, { color: primaryColor }]}>
